...
#__date__ = "01/06/2018"
from ObjectDetection.CameraCalibration.CalibrationImages import CalibrationImages
...
class CameraCalibration:
    ...
    def makeCalibrationimages(self,frame_width,frame_height,camera_index):
        CalibrationImages().getCameraCalibration(frame_width,frame_height,camera_index)


if __name__ == "__main__":
    mtx, dist = CameraCalibration().getCalibration(1)
    print(mtx)
    print(dist)